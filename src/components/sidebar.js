...
const picksData = [
  ...
  {
    picksImage:
      "https://www.allkpop.com/upload/2024/01/content/100912/web_data/allkpop_1704896426_20240110-seulgi.jpg",
    picksAuthor: "Irene",
  ...
  {
    picksImage:
      "https://kpopping.com/documents/74/1/231129-SEVENTEEN-Joshua-MAMA-Awards-2023-documents-1.jpeg?v=81950",
    picksAuthor: "Joshua",
...
export default function Sidebar() {
  ...
  const spanClass = `readingTitle ${theme}`;
  return (
    <div className="fullContainer">
      ...
      <div className="readingList">
        <span className={spanClass}>Reading List</span>
        <p>
        ...
        <a href="#">Terms</a> <a href="#">Text to speech</a>{" "}
        <a href="#">Teams</a>
      </div>
    </div>
  );
